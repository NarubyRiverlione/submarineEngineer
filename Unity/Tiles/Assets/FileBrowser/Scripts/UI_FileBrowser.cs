...
public class UI_FileBrowser : MonoBehaviour {
	...
	// The current buttons list
	public Slider ButtonSize;
	// The height of the buttons

	private string m_pOpenedPath = null;
	// The path of the file you choose to open
	...
	// A variable coupled with a cooldown so you can double click on the menu items to open them
	private Button CurrentlySelected;
	// The currently selected file

	// Folder Managment

	public RectTransform SortModeOptions;
	// The sort modes you can select
	public InputField RenameInputField;
	// The rename input text field

	// Favorites

	public RectTransform FavoritePanel;
	// The panel where the buttons will be displayed
	public Button FavoriteTemplate;
	// The button template
	private List<Button> Favorites;
	// The current buttons list
	public Image FavoriteImage;
	// The "star" image, so we can change it's color to yellow if current folder is already a favorite

	// Filters

	public RectTransform FiltersOptions;
	// The panel where the filters will be displayed
	public Button FilterItem;
	// The filters template
	private List<Button> FiltersList;
	// The filters button list
	private List<string[]> FiltersStrings;
	// A list of strings that will initialize the filters button list
	public Text SelectedFilter;
	// The selected filter text area

	// Search

	public Text SearchField;
	// The search field text area
	public GameObject Loading;

	// Adress Bar

	public InputField CurrentAdress;
	// The search field text area
	...
	// Files that will need a thumbnail
	private List<ThumbData> m_pImagesBytesArray = new List<ThumbData> ();
	// List of the thumbnails data that will be generated from the above FileInfo array
	private bool GenerateNewThumbnails = false;
	// Boolean stating if we need to start generating new thumbnails
	private bool m_bGenerationCompleted = false;
	// Boolean stating the state of the current thumbnail generation
	private bool CancelGeneration = false;
	// Boolean allowing us to cancel the current thumbnails generation
	private bool CancelThread = false;
	// Boolean allowing us to quit to thumbnails thread
	private int ThumbSize;
	// The size of the thumbnails (initialized to the sized if the "ItemSize" slider)
	...
	void Awake () {
		...
		FiltersStrings.Add (new string[] { ".json" });
