...
Starting from an empty scene, simply create a new canvas and drag-and-drop the prefab on it.
 The file browser will be displayed and working, but you the have to setup how to open it.
in the Test scene, if you click on "Cancel", simply press the spacebar to display the menu again. 
take a look at the "TestInput" script to see the simple setup. 
...
5) Create a "Plugins" directory there and copy the file "libgdiplus.dylib"
 from the "lib" directory of Mono 2.10.8 for OSX.
